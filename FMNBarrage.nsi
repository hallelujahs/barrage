...
Section "MainSection" SEC01
  ...
  CreateDirectory "$SMPROGRAMS\风马牛弹幕"
  CreateShortCut "$SMPROGRAMS\风马牛弹幕\风马牛弹幕.lnk" "$INSTDIR\Barrage.exe"
  CreateShortCut "$DESKTOP\风马牛弹幕.lnk" "$INSTDIR\Barrage.exe"
...
Section -AdditionalIcons
  ...
  CreateShortCut "$SMPROGRAMS\风马牛弹幕\Website.lnk" "$INSTDIR\${PRODUCT_NAME}.url"
  CreateShortCut "$SMPROGRAMS\风马牛弹幕\Uninstall.lnk" "$INSTDIR\uninst.exe"
SectionEnd
...
Section Uninstall
  ...
  Delete "$SMPROGRAMS\风马牛弹幕\Uninstall.lnk"
  Delete "$SMPROGRAMS\风马牛弹幕\Website.lnk"
  Delete "$DESKTOP\风马牛弹幕.lnk"
  Delete "$SMPROGRAMS\风马牛弹幕\风马牛弹幕.lnk"

  RMDir "$SMPROGRAMS\风马牛弹幕"
